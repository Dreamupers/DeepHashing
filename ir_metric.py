...
from ir_dataset import NUSWideHashDataset, COCOHashDataset, MIRFlickrHashDataset, test_transform, Cifar10
...
def map_test(model, args):
    ...
    if args.dataset == 'coco2017':
        ...
        query_dataset = MIRFlickrHashDataset(test_transform, 'query')
